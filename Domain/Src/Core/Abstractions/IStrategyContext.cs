...
namespace Domain.Abstractions
{
    ...
    {
        public async Task<TOut> ExecuteStrategy<TKey, TIn, TOut, TStrategy>(TKey key, TIn model, CancellationToken cancellationToken) where TStrategy : IStrategy<TIn, TOut>
        {
